...
ax.set(xlabel = 'n_clusters', ylabel = 'Distorção', title ='Elbow de distorção OBESITY')
ax.grid()
fig.savefig("elbow_distorcao_obesity.png")
plt.show()
...
dump(dados_kmeans_model, open('./obesity_clusters_2024.pkl', 'wb'))
